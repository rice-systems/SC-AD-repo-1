...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        op.addOption("discard", OPT_BOOL, "0", "discard temp buffers");
        op.addOption("lazy", OPT_BOOL, "0", "lazy discard");
        op.addOption("style", OPT_INT, "0", "prefetch & discard style");
        op.addOption("alloc", OPT_INT, "0", "side allocation size");
